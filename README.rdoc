...
Get's around S3's lacking cross domain access header support by storing the upload form on s3, embedded in an iframe.
...
3. Set your server host in app/assets/javascripts/s3_uploader/s3_uploader.js:
