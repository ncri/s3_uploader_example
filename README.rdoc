...
Get's around S3's lack of cross domain access headers by storing the upload form on s3, embedded in an iframe.
Upload Progress is displayed on host server by utilizing postMessage browser communication.
